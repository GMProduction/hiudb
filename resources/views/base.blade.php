            ...
            <div class="collapse navbar-collapse " id="navbarToggler">
                ...
                @if(auth()->user())
                    @if(auth()->user()->role == 'member')
                        <a href="/user">
                            @else
                                <a href="/{{auth()->user()->role == 'comitee' ? 'commitee' : auth()->user()->role}}">
                                    @endif
            ...
            <div class="col">
                <div class="content-footer">
                    ...
                    <table>
                        ...
                        <td>
                            <a style="cursor: pointer" href="https://www.instagram.com/udb.official/" target="_blank"><p>@udb.official</p></a>
                        </td>
                    ...
                    <table>
                        ...
                        <td>
                            <a style="cursor: pointer" href="https://udb.ac.id/" target="_blank"> <p> https://udb.ac.id/</p></a>
